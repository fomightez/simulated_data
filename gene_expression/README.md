...
Presently, you need to fill in the regions by chromosome dictionary in the code. The dictionary can be found inside the script under the `USER ADJUSTABLE VALUES`. I plan to change that to allow you to specify this information on the command line when you call the script eventually.
